...
proc bris_proc { nick host handle chan text } {
	...
	if {$URL_text	!= ""  && [string length $URL_text] > 179} {
	...
	putquick "PRIVMSG AuntieEm :$html"
	putquick "PRIVMSG AuntieEm :$snipped_url_raw1"
	putquick "PRIVMSG AuntieEm :$snipped_url_raw2"
	putquick "PRIVMSG AuntieEm :$snipped_url"
